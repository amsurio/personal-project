...
const Home = () => {
    ...
    const { filterId, page, limit, filteredName, filteredPrice, filteredBook } = useSelector((state: AppStateType) => state.books)
    ...
    }, [page, filterId, filteredName, filteredPrice, filteredBook])
