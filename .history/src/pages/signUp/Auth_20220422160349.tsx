                    ...
                    <Form>
                        <div className={style.form}>
                            ...
                            <div className={style.formItem} >
                                ...
                                <div >
                                    <Field className={style.inputItem} name="email" placeholder="example@mail.com" required />
                                </div>
                            </div>
                            <div className={style.formItem}>
                                <label className={style.label}>Password</label>
                                <div >
                                    <Field className={style.inputItem} name="password" placeholder="Type" type="password" required />
                                </div>
                            </div>
