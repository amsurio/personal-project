...
import { cartSum, countCartItem, myCart } from '../../consts/cartPage';
                ...
                <>
                    ...
                    <div className={style.cartFooter}>
                        <div className={style.infoBlock}>
                            ...
                            <p className={style.cartInfoItem}>{cartSum} <span className={style.counter}>{totalCartPrice ? totalCartPrice : 0}</span>грн.</p>
                        </div>
