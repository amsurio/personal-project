            ...
            <div className={style.card} onClick={() => setOpenBookModal(!openBookModal)}>
                ...
                <div className={style.interactBlock}>
                    ...
                    <div className='d-flex'>
                        {
                            isFavorited ?
                                <Heart key={book.id} color='red' className={`mr-4 ${style.icon}`} size={20} />
                                : <Heart key={book.id} onClick={(e: any) => addBookToFavorite(book.id, e)} className={`mr-4 ${style.icon}`} size={20} />
                        }
