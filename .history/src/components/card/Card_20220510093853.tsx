...
import { author, price } from '../../consts/bookInfo';
...
const Card: FC<CardType> = ({ book }) => {
    ...
    return (<>
        <div className={book.count !== 0 ? style.card : style.disabled} onClick={() => setOpenBookModal(!openBookModal)}>
            ...
            <div className={style.infoBlock}>
                ...
                <p className={style.descText}> {genreObj[book.genreId]}</p>
            </div>
