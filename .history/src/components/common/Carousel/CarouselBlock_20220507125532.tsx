    ...
    return (
        <Carousel fade indicators={false} >
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption className={style.carouselCaption} >
                    <h2 className={style.carouselSlang}>Читання чарівної книги  <br /> покращить твоє самопочуття</h2>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
                <img className={style.imgCarousel}
                ...
                <Carousel.Caption className={style.magicCaption}>
                    <h1 className={`${style.carouselHeadText}`}>у <span className={style.storeName}>ReadBook Store</span></h1>
                </Carousel.Caption>
            </Carousel.Item>
        </Carousel>
