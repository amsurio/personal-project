...
import { carouselFirstBlock1st, carouselFirstBlock2nd, carouselSecondBlock1st, carouselSecondBlock2nd, carouselThirdBlock, readBookStore } from '../../../consts/carousel';
        ...
        <Carousel fade indicators={false} >
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption className={style.magicCaption}>
                    <h1 className={`${style.carouselHeadText}`}>{carouselThirdBlock} <span className={style.storeName}>{readBookStore}</span></h1>
                </Carousel.Caption>
            </Carousel.Item>
        </Carousel>
