    ...
    return (
        <div className={style.container}>
            <div className={style.containerInner}>
                ...
                <button className={style.filterBtn} onClick={() => filterByBookName('ASC')}>Алфавітом</button>
                <button className={style.filterBtn} onClick={() => filterByPrice('ASC')}>Меншою ціною</button>
                <button className={style.filterBtn} onClick={() => filterByPrice('DESC')}>Більшою ціною</button>
            </div>
        </div>
    )
}
