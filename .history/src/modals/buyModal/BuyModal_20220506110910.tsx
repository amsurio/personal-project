                ...
                <Modal.Body>
                    <div>
                        ...
                        {orderArray.map(orderItem => (<>
                            <label>Id</label>
                            <input name='bookId' key={orderItem.book.id} value={orderItem.book.id} type='text' />
                            <label>Name</label>
                            <input name='bookName' key={orderItem.book.id} value={orderItem.book.author} type='text' />
                        </>
                        ))}
