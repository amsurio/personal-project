...
const CreateBookModal: FC<CreateBookModalType> = ({ show, onHide }) => {
    ...
    const addBook = (values: any) => {
        ...
        const book: createBookType = {
            name: formData.append('name', values.name as Blob),
            author: formData.append('author', values.author as Blob),
            description: formData.append('description', values.description as Blob),
            price: formData.append('price', values.price as Blob),
            image: formData.append('image', values.image as Blob),
            genreId: formData.append('genreId', values.genreId as Blob)
        }
        createBook(book)
    }
